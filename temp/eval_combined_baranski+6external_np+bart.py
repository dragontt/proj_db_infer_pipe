...
def main(argv):
    ...
    dir_network = '/Users/KANG/cgscluster/proj_db_infer_pipe/output/fly_network_combined/'
    dir_sub_gmean = 'geometric_mean_baranski_cellcyc_flyat_grav_postfast_sexan_toxic/analysis_flynet/'
    dir_sub_quantile = 'quantile_combine_baranski_cellcyc_flyat_grav_postfast_sexan_toxic/analysis_flynet/'
    fns = []
    # eval_range = ['.full', '.40k']
    # eval_range = ['.genome_wide', '.100k']
    eval_range = ['', '']
    fns.append(dir_sub_gmean + 'analysis_chip_support' + eval_range[0] + '.np.txt')
    fns.append(dir_sub_gmean + 'analysis_pwm_support' + eval_range[1] + '.np.txt')
    ...
    fns.append(dir_sub_gmean + 'analysis_chip_support' + eval_range[0] + '.np_bart.txt')
    fns.append(dir_sub_gmean + 'analysis_pwm_support' + eval_range[1] + '.np_bart.txt')
    ...
    labels = []
    labels.append('chance')
    labels.append('np: geo mean')
    labels.append('np: quant comb')
