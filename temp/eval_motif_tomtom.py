...
def main():
	...
	fns.append(dir_output + 'ortho_scer+spar+smik/' + filename)
	...
	bars = []
	colors = ['r', 'g', 'm', 'c', 'b']
	legend = ('fire_motifs', 'fire_motifs_orthos_spar+smik', 'fire_motifs_orthos_smik+skud+sbay', 'fire_motifs_orthos_smik+skud+sbay+scas+sklu', 'cisbp_motifs')
