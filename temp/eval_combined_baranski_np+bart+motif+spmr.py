...
def main(argv):
    ...
    dir_network = '/Users/KANG/proj_db_infer_pipe/output/fly_network_combined/'
    dir_sub_gmean = 'fly_network_singles_net_full_np_bart_geometric_mean/'
    dir_sub_quantile = 'fly_network_singles_net_full_np_bart_quantile_combine/'
    fns = []
    fns.append(dir_sub_gmean + 'analysis_chip_support.np_bart.txt')
    fns.append(dir_sub_gmean + 'analysis_pwm_support.np_bart.txt')
    fns.append(dir_sub_quantile + 'analysis_chip_support.np_bart.txt')
    fns.append(dir_sub_quantile + 'analysis_pwm_support.np_bart.txt')
    fns.append(dir_sub_gmean + 'analysis_chip_support.np_bart_pwm.txt')
    fns.append(dir_sub_gmean + 'analysis_pwm_support.np_bart_pwm.txt')
    fns.append(dir_sub_quantile + 'analysis_chip_support.np_bart_pwm.txt')
    fns.append(dir_sub_quantile + 'analysis_pwm_support.np_bart_pwm.txt')
    fns.append(dir_sub_gmean + 'analysis_chip_support.np_bart_pwm_spmr.txt')
    fns.append(dir_sub_gmean + 'analysis_pwm_support.np_bart_pwm_spmr.txt')
    fns.append(dir_sub_quantile + 'analysis_chip_support.np_bart_pwm_spmr.txt')
    fns.append(dir_sub_quantile + 'analysis_pwm_support.np_bart_pwm_spmr.txt')

    # figure setup
    colors = ['k:', 'r', 'r--', 'g', 'g--', 'b', 'b--']
    labels = []
    labels.append('chance')
    labels.append('np+bart: geo mean')
    labels.append('np+bart: quant comb')
    labels.append('np+bart+pwm: geo mean')
    labels.append('np+bart+pwm: quant comb')
    labels.append('np+bart+pwm+spmr: geo mean')
    labels.append('np+bart+pwm+spmr: quant comb')
