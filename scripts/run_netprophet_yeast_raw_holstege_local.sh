...
# microarray
netprophet -m -l -t ${dir_res}/data.expr -r ${dir_res}/rdata.expr -a ${dir_res}/allowed.adj -p ${dir_res}/data.pert.adj -d ${dir_res}/prior.adj -g ${dir_res}/gids -f ${dir_res}/rids 
