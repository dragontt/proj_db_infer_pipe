...
maxRank <- 40000
fnRankCaption <- "chip.bp.np.set.sizes.top4to40k."
...
np_conf_cutoffs <- net$CONFIDENCE[order(net$CONFIDENCE,decreasing=TRUE)][seq(maxRank/10,maxRank,by=maxRank/10)]
...
fnOutName <- paste(fnRankCaption,tempBasename,".txt", sep="")
