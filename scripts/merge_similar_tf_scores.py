#!/usr/bin/python
""" 
Merge TF network scores by weighted averaging, where the weight uses DBD-PWM similarity fit. The sigmoid fit learnt is: 
    Fraction of TFs w. similar PWMs = 0.9 / (1 + exp(- 0.1*(DBD percent identity - 40)))
"""
import sys
import os
import glob
