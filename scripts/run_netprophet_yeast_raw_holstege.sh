...
dir_out=/home/mblab/ykang/proj_db_infer_pipe/output/yeast_network_raw_holstege_np
...
# microarray
netprophet -m -c -t ${dir_res}/data.expr -r ${dir_res}/rdata.expr -a ${dir_res}/allowed.adj -p ${dir_res}/data.pert.adj -d ${dir_res}/prior.adj -g ${dir_res}/genes -f ${dir_res}/regulators 
