...
# python script/bartnp_infer_pwm/parse_fire_summary.py -i resources/yeast_bart_holstege/holstegeBartNp_binned/ -o resources/yeast_bart_holstege/holstegeBartNp.txt
